...
namespace UI
{
    namespace UIElement
    {
        sf::Font TextView::font_ArcadeI;
        sf::Font TextView::font_ArcadeN;
        ...
        {
            font_ArcadeI.loadFromFile(Global::Config::ArcadeI_font_path);
            font_ArcadeN.loadFromFile(Global::Config::ArcadeN_font_path);
        }
        ...
        void TextView::setFont(FontType font_type)
        {
            switch (font_type)
            {
            case FontType::ARCADE_I:
                text.setFont(font_ArcadeI);
                break;
            case FontType::ARCADE_N:
                text.setFont(font_ArcadeN);
                break;
            }
        }
