...
namespace Global
{
	const sf::String Config::game_logo_texture_path = "Assets/Textures/game_logo.png";
	...
	const sf::String Config::triple_laser_texture_path = "Assets/Textures/triple_laser.png";
	const sf::String Config::rapid_fire_texture_path = "Assets/Textures/rapid_fire.png";
	
	const sf::String Config::player_bullet_texture_path = "Assets/Textures/player_bullet.png";
	const sf::String Config::laser_bullet_texture_path = "Assets/Textures/laser_bullet.png";
	const sf::String Config::torpedo_texture_path = "Assets/Textures/torpedoe.png";
	...
	const sf::String Config::bullet_fire_sound_path = "assets/sounds/bullet_fire.wav";
